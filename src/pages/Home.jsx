...
const Home = () => {
    ...
    useEffect(() => {
        const fetchPosts = async () => {
            ...
            try {
                const response = await fetch('https://texttoimagebackend-production-1bd2.up.railway.app/api/v1/post', {
                    method: 'GET',
                    headers: {
    ...
    return (
        <section className='max-w-7xl mx-auto'>
            <div className='justify-center text-center'>
                ...
                <h1 className="mb-4 text-3xl font-extrabold text-gray-900 dark:text-black md:text-5xl lg:text-6xl">Divine Studio<span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Text-to-Image</span> AI Generator.</h1>
                <p className="text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">Dive into a world of imagination with Divine Studio Text-to-Image Generator. Explore captivating visuals crafted effortlessly. Click "Create" to unleash your creativity!</p>
            </div>
